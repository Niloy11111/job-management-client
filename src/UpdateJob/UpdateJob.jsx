...
const UpdateJob = () => {
  ...
  return (
    <div className="mb-20">
      <h2 className="text-4xl font-Inter font-medium text-center my-7  ">
        Let's Update a Job
      </h2>
      <form className="" onSubmit={handleUpdateJob}>
        <div className="lg:w-2/4 mx-auto">
          ...
          <label htmlFor="">
            ...
            <input
              className=" pl-5 bg-[#FFF]  rounded py-3 outline-none w-full block border pb-3 mb-4"
              type="text"
          ...
          <label htmlFor="">
            ...
            <ReactDatePicker
              className=" pl-5 bg-[#FFF]  rounded py-3 outline-none w-[380px] block border pb-3 mb-6"
          ...
          <button className="w-full bg-[#009EE2] py-3 rounded text-[#FFF] text-base font-Inter font-medium">
            {" "}
            Update This Job{" "}
          </button>
        </div>
