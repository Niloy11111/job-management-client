  ...
  <div className="">
    <form onSubmit={handleLogin} className="px-7 lg:px-14 rounded  lg:w-[570px]">
      ...
      <div>
        ...
        <input className="border-[#009EE2] bg-[#FFF] rounded-lg py-3 outline-none w-full border b block pl-5 pb-3 mb-8" type="email" placeholder="Username or Email" name="email" required />
        ...
        <input className="border-[#009EE2] bg-[#FFF] border  pl-5 rounded-lg py-3 outline-none w-full block border-b pb-3 mb-4" type="text" placeholder="Photo URL" name="photo-url" required />
      </div>
